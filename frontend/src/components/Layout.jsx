  ...
  return (
    <div className="min-h-screen flex bg-gray-50">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="bg-white border-b border-gray-200 px-2 sm:px-4 lg:px-8 py-2.5 sm:py-4 flex items-center justify-between no-print shadow-sm sticky top-0 z-30">
        ...
        <main className="flex-1 p-2 sm:p-4 lg:p-8 overflow-auto"><Outlet /></main>
      </div>
    </div>
  );
}
